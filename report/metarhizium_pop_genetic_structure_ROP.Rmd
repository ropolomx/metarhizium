...
non-glaciated locations as prior locations (or inside and outside, respectively). 
...
Montane Cordilla South Ecozone, Agricultural). 



![](../glaciation_structure.png)

Figure 1. Bayesian analysis of population structure of _Metarhizium bruuneum_(A) and _Metarhizium
robertsii_ (B) with STRUCTURE. Barplots were generated for ancestry coefficients calculated with CLUMPP.
